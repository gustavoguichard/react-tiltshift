...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcTiltshift = __webpack_require__(87);

	var _srcTiltshift2 = _interopRequireDefault(_srcTiltshift);

	var Maybe = function Maybe(obj, value) {
	...
	var App = (function (_Component) {
	  ...
	  App.prototype.handleChange = function handleChange() {
	    this.setState({
	  ...
	  App.prototype.handleDirectionSource = function handleDirectionSource(event) {
	  ...
	  App.prototype.render = function render() {
	    ...
	    var blur = _state.blur;
	    var aperture = _state.aperture;
	    var direction = _state.direction;
	    var directionAngle = _state.directionAngle;
	    var position = _state.position;
	    var smoothness = _state.smoothness;

	    var directionValue = this.validDirection;
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_srcTiltshift2['default'], { src: 'sf.jpg', aperture: aperture, blur: blur, direction: directionValue, position: position, smoothness: smoothness, width: '600' })
	      ),
	      _react2['default'].createElement(
	        'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'label',
	                  { className: 'control-label', htmlFor: 'blur' },
	                  'Blur radius:'
	                ),
	                _react2['default'].createElement('input', { className: 'form-control', ref: 'blurField', id: 'blur', type: 'number', min: '0', max: '10', step: '.5', defaultValue: blur, onChange: this.handleChange })
	              )
	            ),
	            _react2['default'].createElement(
	              'div',
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'label',
	                  { className: 'control-label', htmlFor: 'aperture' },
	                  'Aperture:'
	                ),
	                _react2['default'].createElement('input', { className: 'form-control', ref: 'apertureField', id: 'aperture', type: 'number', min: '0', max: '100', defaultValue: aperture, onChange: this.handleChange })
	              )
	            ),
	            _react2['default'].createElement(
	              'div',
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { className: 'form-control', ref: 'positionField', id: 'position', type: 'number', min: '0', max: '100', defaultValue: position, onChange: this.handleChange })
	              )
	            )
	          ),
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'label',
	                  { className: 'control-label', htmlFor: 'smoothness' },
	                  'smoothness:'
	                ),
	                _react2['default'].createElement('input', { className: 'form-control', ref: 'smoothnessField', id: 'smoothness', type: 'number', min: '0', max: '100', defaultValue: smoothness, onChange: this.handleChange })
	              )
	            ),
	            _react2['default'].createElement(
	              'div',
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'label',
	                  { className: 'control-label', htmlFor: 'direction' },
	                  'direction:'
	                ),
	                _react2['default'].createElement(
	                  'select',
	                  { className: 'form-control', defaultValue: direction, onChange: this.handleDirectionSource },
	                  _react2['default'].createElement(
	                    'option',
	                    { value: 'horizontal' },
	                    'Horizontal'
	            ...
	            direction == "angle" && _react2['default'].createElement(
	              'div',
	              { className: 'col-xs-4' },
	              _react2['default'].createElement(
	                'div',
	                ...
	                _react2['default'].createElement(
	                  ...
	                  _react2['default'].createElement('input', { className: 'form-control', ref: 'directionField', id: 'direction', type: 'number', min: '0', max: '360', defaultValue: directionAngle, onChange: this.handleChange }),
	                  _react2['default'].createElement(
	                    'span',
	  ...
	  _createClass(App, [{
	    ...
	    get: function get() {
	      ...
	      var directionAngle = _state2.directionAngle;
	...
	_reactDom2['default'].render(_react2['default'].createElement(App, null), document.getElementById('react-main'));
...
/***/ function(module, exports) {
	...
	var inRange = function inRange(val, range) {
	  return val >= range[0] && val <= range[1];
	};

	var anglePropType = function anglePropType(props, propName, component) {
	...
	exports.anglePropType = anglePropType;
	var rangePropType = function rangePropType(props, propName, component) {
	  var prop = props[propName],
	      range = [0, 100];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TiltShift = (function (_Component) {
	  _inherits(TiltShift, _Component);

	  function TiltShift() {
	    _classCallCheck(this, TiltShift);
	  ...
	  TiltShift.prototype.render = function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement('img', _extends({ src: src }, this.props)),
	      _react2['default'].createElement('div', { style: topSty }),
	      _react2['default'].createElement('div', { style: bottomStyl })
	    );
	  };

	  _createClass(TiltShift, null, [{
	    key: 'propTypes',
	    value: {
	      aperture: _propTypes.rangePropType,
	      blur: _propTypes.rangePropType,
	      direction: _propTypes.anglePropType,
	      position: _propTypes.rangePropType,
	      smoothness: _propTypes.rangePropType,
...
/***/ function(module, exports) {
	...
	var toAngle = function toAngle(val) {
	  return val + "deg";
	};
	var getAngle = function getAngle(dir, values) {
	  return isNaN(dir) ? toAngle(values[dir]) : toAngle(dir % 360 + values.axis);
	};

	var bottomAngle = function bottomAngle(dir) {
	  return getAngle(dir, {
	    horizontal: 90, vertical: 0, axis: 0
	  });
	};

	exports.bottomAngle = bottomAngle;
	var topAngle = function topAngle(dir) {
	  return getAngle(dir, {
	    horizontal: 270, vertical: 180, axis: 180
	  });
	};
	exports.topAngle = topAngle;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMServer = __webpack_require__(110);
	var ReactIsomorphic = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(17);
	var ReactMarkupChecksum = __webpack_require__(66);
	var ReactServerBatchingStrategy = __webpack_require__(122);
